...
function MenuAndStat() {
    ...
    console.log(currentDate); // Outputs something like "July 17, 2025"

    return (
        <>
            <div class=" flex px-5 bg-base-200 ">
                <div name="tabs" className="tabs tabs-border w-screen ">
                    ...
                    <a class="btn btn-ghost btn-circle border-gray-100 bg-gray-100 ml-3" href="#">
                        <FontAwesomeIcon class="transform rounded-lg w-5 h-5" icon={faEllipsis} />
                    </a>
                </div>
            </div>
                <div>
